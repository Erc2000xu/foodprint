...
const statusLabel = (status: MemberDirectoryRow["status"]) => ({ active: "正常使用", suspended: "暂停使用", removed: "已移除" })[status];
...
export default async function AdminPage() {
  ...
  if (!membership) return <main className="auth-page"><section className="auth-card"><h1>你还没有加入共同地图。</h1><p>请通过朋友分享的邀请链接加入食迹。</p></section></main>;
